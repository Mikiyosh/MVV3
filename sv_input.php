...
<form action="sv_create.php" method="POST">
        ...
        <input type="button" value="次へ" onclick="showQuestion('k_01', 'k_02')">
     ...
     <div id="k_02" class="kfit" style="display: none;">
      ...
      <input type="button" value="次へ" onclick="showQuestion('k_02', 'k_03')">
 ...
 <!-- 質問3 -->
   ...
   <input type="button" value="次へ" onclick="showQuestion('k_03', 'k_04')">
          </div> 
    ...
    <div id="k_04" class="kfit" style="display: none;">
        ...
        <ul>
         ...
         <input type="button" value="次へ" onclick="showQuestion('k_04', 'k_05')">
    ...
    <div id="k_05" class="kfit" style="display: none;">
        ...
        <ul>
            ...
            <li><input class="kbtn" type="radio" name="r5" value="6.0">非常にそう思う</li>
               ...
               <input type="button" value="次へ" onclick="showQuestion('k_05', 'k_06')">
    ...
    <div id="k_06" class="kfit" style="display: none;">
        ...
        <ul>
            ...
            <li><input class="kbtn" type="radio" name="r6" value="6.0">非常にそう思う</li>
               ...
               <input type="button" value="次へ" onclick="showQuestion('k_06', 'k_07')">
    ...
    <div id="k_07" class="kfit" style="display: none;">
        ...
        <ul>
            ...
            <li><input class="kbtn" type="radio" name="r7" value="6.0">非常にそう思う</li>
               ...
               <input type="button" value="次へ" onclick="showQuestion('k_07', 'k_08')">
         </div>
    ...
    <div id="k_08" class="kfit" style="display: none;">
     ...
     <input type="button" value="次へ" onclick="showQuestion('k_08', 'k_09')">
                  </div>
    ...
    <div id="k_09" class="kfit" style="display: none;">
     ...
     <input type="button" value="次へ" onclick="showQuestion('k_09', 'k_10')">
                 </div>
    ...
    <div id="k_10" class="kfit" style="display: none;">
     ...
     <input type="button" value="次へ" onclick="showQuestion('k_10', 'k_11')">
                 </div>
   ...
   <input type="button" value="次へ" onclick="showQuestion('k_11', 'k_12')">
                  </div>
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_12', 'k_13')">
                  </div>
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_13', 'k_14')">
                 </div>
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_14', 'k_15')">
           </div>
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_15', 'k_16')">
           </div>
               <!-- 質問16 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_16', 'k_17')">
           </div>
               <!-- 質問17 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_17', 'k_18')">
           </div>
               <!-- 質問18 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_18', 'k_19')">
           </div>
               <!-- 質問19 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_19', 'k_20')">
           </div>
               <!-- 質問20 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_20', 'k_21')">
           </div>
               <!-- 質問21 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_21', 'k_22')">
           </div>
               <!-- 質問22 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_22', 'k_23')">
           </div>
               <!-- 質問23 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_23', 'k_24')">
           </div>
               <!-- 質問24 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_24', 'k_25')">
           </div>
               <!-- 質問25 -->
    ...
    <input type="button" value="次へ" onclick="showQuestion('k_25', 'k_26')">
           </div>
               <!-- 質問26 -->
    ...
    <input type="submit" value="送信" onclick="showQuestion('k_26', 'k_27')">
           </div>
