...
<body>
  ...
  <main>
    ...
    <div class="evasheet_wrapper2">
      <div id="kpitop" class="eva_sheet">目標設定シート</div>
      <p>上記の自己評価を踏まえ次回までの目標設定を行って下さい。</p>
        ...
        <ul class="whole_wrapper">
          <li class="box2">
            <div class="kno_div">
              ...
              <div class="formselfeva2">
                <input type="ktext" id="ktext">
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal01">文章作成力</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal02">テクニカルスキル</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal03">ラーニングアジリティ</a><br>
              </div>
          ...
          <li class="box2">
            <div class="kno_div">
              ...
              <div class="formselfeva2">
                <input type="itext" id="itext">
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal04">企画発案力</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal05">問題定義と改善</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal06">探求心と追求心</a><br>
              </div>
          ...
          <li class="box2">
            <div class="le_div">
              ...
              <div class="formselfeva2">
                <input type="ltext" id="ltext">
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal07">ビジョニング力</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal08">目標設定と遂行力</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal09">影響力</a><br>
              </div>
          ...
          <li class="box2">
            <div class="fol_div">
              ...
              <div class="formselfeva2">
                <input type="ftext" id="ftext">
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal10">翻訳力</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal11">プロジェクトマネジメント</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal12">チームマネジメント</a><br>
              </div>
          ...
          <li class="box2">
            <div class="hos_div">
              ...
              <select id="hos">
                <option value="">項目を選択してください</option>
                <option value="">人財育成</option>
                <option value="メンバーシップ">メンバーシップ</option>
                <option value="セルフマネジメント">セルフマネジメント</option>
              </select>
              <div class="formselfeva2">
                <input type="htext" id="htext">
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal13">人財育成</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal14">メンバーシップ</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal15">セルフマネジメント</a><br>
              </div>
          ...
          <li class="box2">
            <div class="fle_div">
              ...
              <div class="formselfeva2">
                <input type="fltext" id="fltext">
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal16">現場力</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal17">トラブル対応力</a><br>
              </div>

              <div class="content">
                <a class="js-modal-open" href="" data-target="modal18">クライアント対応力</a><br>
              </div>
      ...
      <div class="wholeform">
        <div class="ev_form">
          ...
          <div class="formname2">
            氏名: <input type="name2" id="name2">
          </div>


          <div class="formselfeva">
            目標（フリー記述）: <input type="text2" id="text2">
          </div>
    ...
    <div class="evasheet_wrapper">
      ...
      <div class="formname">
        氏名: <input type="name3" id="name3" placeholder="キーワードを入力してください">
      </div>
      ...
      <div>
        <button type="button" id="evaresult">評価結果を見る</button>
      </div>
